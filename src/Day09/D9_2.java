    ...
    public static void main(String[] args) throws Exception {
        ...
        do {
            ...
            while (a[0][0] == -1 || a[0][z] != -1) {
                ...
                if (a[1][z]-1 > -1 && !m[a[1][z]-1][a[0][z]]) {
                    m[a[1][z]-1][a[0][z]] = true;
                    a[1][c] = a[1][z]-1;
                    a[0][c] = a[0][z];
                    c++;
                }
                if (a[1][z]+1 < 100 && !m[a[1][z]+1][a[0][z]]) {
                    m[a[1][z]+1][a[0][z]] = true;
                    a[1][c] = a[1][z]+1;
                    a[0][c] = a[0][z];
                    c++;
                }
                if (a[0][z]-1 > -1 && !m[a[1][z]][a[0][z]-1]) {
                    m[a[1][z]][a[0][z]-1] = true;
                    a[1][c] = a[1][z];
                    a[0][c] = a[0][z]-1;
                    c++;
                }
                if (a[0][z]+1 < 100 && !m[a[1][z]][a[0][z]+1]) {
                    m[a[1][z]][a[0][z]+1] = true;
                    a[1][c] = a[1][z];
                    a[0][c] = a[0][z]+1;
                    c++;
